...
{{-- <html>
    ...
    {{@csrf_field()}}
        <input type="text" value="{{old('username')}}" name="username" placeholder="Username"><br>
          @error('username')
           ...
           <div class="row">
              <div class="col-md-4 offset-md-4">
                  <div class="signup-form">
                      <form Action="{{route('login')}}" method="post" class="mt-5 border p-4 bg-light shadow">
                      {{@csrf_field()}}
                      <h3 class="mb-5 text-secondary">Log In As Student</h3>
                        <div class="mb-3">
